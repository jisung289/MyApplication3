...
public class Write_feed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UploadImageOnServerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               progressDialog = ProgressDialog.show(Write_feed.this,"글을 저장중입니다.","잠시만 기다려주세요",false,false);
        ...
        GetImageName.addTextChangedListener(new TextWatcher()
        {
            ...
            {
                if (GetImageName.getLineCount() >= 6)
                {
