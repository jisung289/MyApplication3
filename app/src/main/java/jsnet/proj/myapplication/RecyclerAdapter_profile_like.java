...
public class RecyclerAdapter_profile_like extends RecyclerView.Adapter<RecyclerAdapter_profile_like.ViewHolder> {
    Context context;
    List<Item> items;
    int item_layout;
    private String A;
    ...
    public RecyclerAdapter_profile_like(Context context, List<Item> items, int item_layout) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_listview, null);
