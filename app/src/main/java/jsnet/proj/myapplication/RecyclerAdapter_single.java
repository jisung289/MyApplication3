...
public class RecyclerAdapter_single extends RecyclerView.Adapter<RecyclerAdapter_single.ViewHolder> {
    Context context;
    List<Item> items;
    int item_layout;
    private String A;
    ...
    public RecyclerAdapter_single(Context context, List<Item> items, int item_layout) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_singleline, null);
