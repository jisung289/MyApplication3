...
public class RecyclerAdapter_profile_list extends RecyclerView.Adapter<RecyclerAdapter_profile_list.ViewHolder> {
    Context context;
    List<Item> items;
    int item_layout;
    private String A;
    ...
    public RecyclerAdapter_profile_list(Context context, List<Item> items, int item_layout) {
