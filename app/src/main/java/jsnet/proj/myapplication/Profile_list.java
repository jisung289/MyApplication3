...
public class Profile_list extends Fragment
{
    ...
    RecyclerAdapter_profile_list RecyclerAdapter = null;
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            jsonobject = JSONfunctions
                    .getJSONfromURL("http://file.paranweb.co.kr/gay/board_app_m.php?uk="+user_token+"&p="+ String.valueOf(page_int));


            Log.d("json_url", "http://file.paranweb.co.kr/gay/board_app_m.php?uk="+user_token+"&p="+ String.valueOf(page_int));
            if(jsonobject==null) {
                return null;
            }
            try {
        ...
        protected void onPostExecute(Void args) {
            if(jsonarray!=null) {
                ...
                if(re_view==0) {
                    ...
                    RecyclerAdapter=new RecyclerAdapter_profile_list(getActivity(), items, R.layout.fragment_first);
